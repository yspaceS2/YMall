...
@Component
@Validated
@ConfigurationProperties(prefix = "ymall.email-change")
public class EmailChangeProperties {
    ...
    @NotNull
    @DurationMin(seconds = 1)
    private Duration reauthenticationTtl = Duration.ofMinutes(10);
    ...
    public Duration getReauthenticationTtl() {
        return reauthenticationTtl;
    }

    public void setReauthenticationTtl(Duration reauthenticationTtl) {
        this.reauthenticationTtl = reauthenticationTtl;
    }
