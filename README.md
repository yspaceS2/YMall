...
프록시, 수동 CD와 롤백 절차를 준비했습니다. 실제 인스턴스 생성, DNS 연결, 운영 Secret 등록과 외부
헬스체크는 OCI 계정 업그레이드 및 인스턴스 프로비저닝이 완료된 뒤 검증합니다. 구체적인 준비 항목과
실행 순서는 [OCI 배포 가이드](docs/deployment/oci.md)에 정리했습니다.
